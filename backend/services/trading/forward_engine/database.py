"""
Database operations for forward test engine.

Purpose:
    Handle all database update operations for forward test sessions,
...
class DatabaseManager:
    """
    Manages database operations for forward test sessions.
