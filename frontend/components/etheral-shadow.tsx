...
export const Component = memo(function ShadowOverlay({
    sizing = 'fill',
    ...
    const animationDuration = animation ? mapRange(animation.speed, 1, 100, 500, 100) : 1;
    ...
    useEffect(() => {
        if (feColorMatrixRef.current && animationEnabled) {
            ...
            let lastUpdate = 0;
            const throttleMs = 50; // Update max 20fps instead of 60fps
